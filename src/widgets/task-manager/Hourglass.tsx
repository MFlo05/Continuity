...
// Adapted from the original Command Center's hourglass reference
// (command-Center-Refrence/src/hourglass.tsx) — same SVG/animation, with two
// changes: React.useId() swapped for the named import, and the top bulb
// (originally a perfect <circle>) replaced with a path mirroring the bottom
// bulb's shape (y' = 182 - y) so both bulbs taper into the neck the same way.
      ...
      <svg viewBox="0 0 100 184" width={size} height={size * (184 / 100)}
        ...
        <defs>
          ...
          <clipPath id={id('topClip')}>
            <path d="M 47 88 C 47 86 48 84 50 83 C 52 84 53 86 53 88 C 70 82 92 64 92 34 C 92 14 74 4 50 4 C 26 4 8 14 8 34 C 8 64 30 82 47 88 Z" />
          </clipPath>
        ...
        {/* Top bulb — mirror of the bottom bulb path (y' = 182 - y), not a
            circle, so it tapers into the neck the same way the bottom does
            instead of reading as a perfect sphere. */}
        <path d="M 47 88 C 47 86 48 84 50 83 C 52 84 53 86 53 88 C 70 82 92 64 92 34 C 92 14 74 4 50 4 C 26 4 8 14 8 34 C 8 64 30 82 47 88 Z" fill={`url(#${id('glass')})`} />
        <path d="M 47 88 C 47 86 48 84 50 83 C 52 84 53 86 53 88 C 70 82 92 64 92 34 C 92 14 74 4 50 4 C 26 4 8 14 8 34 C 8 64 30 82 47 88 Z" fill={`url(#${id('topRim')})`} />
        ...
        <path d="M 47 88 C 47 86 48 84 50 83 C 52 84 53 86 53 88 C 70 82 92 64 92 34 C 92 14 74 4 50 4 C 26 4 8 14 8 34 C 8 64 30 82 47 88 Z" fill="none" stroke="rgba(255,255,255,0.20)" strokeWidth="0.6" />
